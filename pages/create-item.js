...
const projectId = "2FhgshNX8NOtKNJWbring3OMUXw";
const projectSecret = "33a3a00f59b8ff5d3de0958a5adf08f8";
const auth =
...
export default function CreateItem() {
  ...
  async function onChange(e) {
    ...
    try {
      ...
      const url = `https://openocean.infura-ipfs.io/ipfs/${result.path}`;
      setFileUrl(url);
    } catch (e) {
